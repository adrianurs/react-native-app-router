...
const generateRoutesPath = "scripts/generate-routes.js";
const generateImportsPath = "scripts/generate-imports.js";
...
function watchAppDir() {
  ...
  const unscribe = () =>
    spy.unsubscribe(screensDir, runGeneratorScripts, { persistent: true });
  return unscribe;
}
